...
# 
Ventas TYD = CALCULATE( Ventas[Ventas totales] , YEAR(Calendario[Date]) = YEAR(MAX(Calendario[Date])))
#
Ventas vs PM = 
var diferencia = Ventas[Ventas totales]-Ventas[Ventas PM]
var validacion = IF(ISBLANK(Ventas[Ventas PM]),BLANK(), diferencia )

return validacion
#
Ventas vs PM % = DIVIDE(Ventas[Ventas vs PM],Ventas[Ventas totales])